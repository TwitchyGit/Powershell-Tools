...
$server = "ldapuat.x.com"   # or "ldapuat.x.com:1389" if you want a specific port

# If you need a specific port, use this instead:
# $id = [System.DirectoryServices.Protocols.LdapDirectoryIdentifier]::new("ldapuat.x.com",1389,$false,$false)
